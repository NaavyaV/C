...
// Sundeep code changes start
  ...
  playerSpeed = canW / 60; //fix hardcode
  playerYSpeed = canH / 20; //fix hardcode
  truckMaxSpeed = canH / 95;//fix hardcode
  truckMinSpeed = canH / 80;//fix hardcode
}
